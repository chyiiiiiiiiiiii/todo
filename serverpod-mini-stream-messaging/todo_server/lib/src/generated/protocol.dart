...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.TodoTasks) {
      return _i4.TodoTasks.fromJson(data) as T;
    }
    if (t == _i1.getType<_i3.Task?>()) {
      return (data != null ? _i3.Task.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i4.TodoTasks?>()) {
      return (data != null ? _i4.TodoTasks.fromJson(data) : null) as T;
    }
    if (t == List<_i5.Task>) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'TodoTasks') {
      return deserialize<_i4.TodoTasks>(data['data']);
    }
