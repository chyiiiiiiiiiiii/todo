...
import 'task_exception.dart' as _i4;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.CreateTaskException) {
      return _i4.CreateTaskException.fromJson(data) as T;
    }
    if (t == _i1.getType<_i3.Task?>()) {
      return (data != null ? _i3.Task.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i4.CreateTaskException?>()) {
      return (data != null ? _i4.CreateTaskException.fromJson(data) : null)
          as T;
    }
    if (t == List<_i5.Task>) {
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i4.CreateTaskException) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'CreateTaskException') {
      return deserialize<_i4.CreateTaskException>(data['data']);
    }
